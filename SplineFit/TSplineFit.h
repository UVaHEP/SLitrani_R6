// @(#)root/html:$Id: TSplineFit.h 2008-06-11
...
protected:
  ...
  TString            fYLabel;        //Label of the y axis
  TString            fZLabel;        //Label of the z axis
...
public:
  ...
  static TReference *fgRef;          //References of program SplineFit
  ...
  static  void       DrawFitsInFile(Int_t = 0);
  ...
  Bool_t             GetMemoryReduced() const       { return fMemoryReduced;       }
  TMultiGraph       *GetMultiGraph() const          { return fPS;                  }
  ...
  Double_t           GetRandom(Int_t,Double_t,Bool_t=kFALSE);
  ...
  Bool_t             GetUseForRandom() const        { return fUseForRandom;        }
  ...
  static void        NameFile(const char* = "SplineFitDB.rdb");
  static void        NameProg(const char *);
  static void        NameWeb(const char *);
  ...
  static void        ShowFitsInCollection();
  ...
  static void        SortCollection()               { TSplineFit::fgFits->Sort(); }
