...
/* BEGIN_HTML
		...
		<p>Identical versions of <b><code>TLitSpectrum</code></b> and <b><code>TLitSpectrumCp</code></b> 
are used in <b><code><a href="http://gentit.home.cern.ch/gentit/litrani/">Litrani</a></code></b> 
and in <b><code><a href="http://irfu.cea.fr/pisp/gentit/SLitrani/">SLitrani</a></code></b>.</p>
...
have decided in <b><code>SLitrani</code></b> to decompose the global scintillation 
...
provided with <b><code>SLitrani</code></b> in the directory &quot;<b><code>FitMacros</code></b>&quot;. 
...
decay and rise times. Notice the appearance of 2 different types of weights:</p>
		<ul>
...
the methods <b><code>Normalize()</code></b> will do it.</p>
		...
		<p>In this new version of <b><code>SLitrani</code></b>, there are 2 possible distribution 
...
(1 -exp(-t/t<sub>r</sub>))</b></code>
		...
		<p>The first formula was the only available in the previous version of <b><code>SLitrani</code></b>. 
...
macros </p>
		...
		<p>given with <b><code>SLitrani</code></b> in the directory <b><code>FitMacros</code></b>. 
...
is delivered with [<b><code>S]Litrani</code></b> in the directory <b><code>Database</code></b>, 
as <b><code>SplineFitDB.rdb</code></b>. Once a spectrum is inside the database, you 
can retrieve it, for instance from the class <b><code><a href="TLitMedium.html">TLitMedium</a></code></b>, 
using the method <b><code><a href="TLitMedium.html#TLitMedium:FindSpectrum">TLitMedium::FindSpectrum()</a></code></b>.</p>
...
the executable <b><code>&quot;[S]Ltrani&quot;</code></b> [linux] or <b><code>&quot;[S]Litrani.exe&quot;</code></b> 
[Windows].&nbsp;In that case, you have nothing to do and <b><code>[S]Litrani</code></b> 
will immediatly find the 2 files. For instance,</p>
		<ul>
			<li>if you start <b><code>SLitrani</code></b> from the directory &quot;<b><code>.../SLitrani</code></b>&quot; 
where you have compiled and linked it, then put the two database files there.
			<li>if you start <b><code>SLitrani</code></b> from the directory &quot;<b><code>$ROOTDEV/bin</code></b>&quot; 
...
where the executable <b><code>&quot;SLitrani&quot;</code></b> is, but want to put 
these two files into a specified directory, for instance			<ul>
...
This method is called by the method <b><code><a href="TLitMedium.html#TLitMedium:WaveAndLife">TLitMedium::WaveAndLife()</a></code></b>; 
time is given in ns.</p>
		<p></p>
		<h3>6- Drawings</h3>
		<p>You can ask for the drawing of the global wavelength spectrum of a <b><code>TLitSpectrum 
*p</code></b> by:</p>
		<ul>
		...
		<p>In the directory <b><code>&quot;FitMacros&quot;</code></b> provided with <b><code>[S]Litrani</code></b>, 
...
Bool_t TLitSpectrum::BetterPeaks(Int_t Npeaks,Double_t *mean,Double_t *sigma,Double_t *weight,
  ...
  if (bavard) {
    ...
    gCleanOut->M(info,"");
    for (i=0;i<Npeaks;i++) {
      gCleanOut->MIR(info,"peak",i,"norm",ppar[3*i]);
...
//
  ...
  if (bavard) {
    ...
    gCleanOut->M(info,"");
    for (i=0;i<gLitSpecNb;i++) {
      gCleanOut->MIR(info,"peak",i,"X",PositionX[i]);
  ...
  for (p=0;p<nfound;p++) {
    ...
    if ((TMath::Abs(xp-xmin)<tooclose) || (TMath::Abs(xmax-xp)<tooclose)) {
      gCleanOut->MMR(warning,met,"Peak too close to edge. We eliminate it","xp",xp,ClassName());
    }
    else {
