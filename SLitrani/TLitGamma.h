...
public:
  ...
  Bool_t            SetEmission(KindOfDist=flat,Double_t=1.0,TVector3=TVector3(0,0,0),const char* ="",
                      Bool_t=kFALSE,TVector3=TVector3(0,0,0),Bool_t=kTRUE,TVector3=TVector3(0,0,0));
