...
public:
  ...
  Bool_t         SetEmission(KindOfDist=on4pi,Double_t=180.0,TVector3=TVector3(0,0,0),
                   const char* = "",Bool_t=kFALSE,TVector3=TVector3(0,0,0),Bool_t=kFALSE,TVector3=TVector3(0,0,0));
  ...
  Bool_t         SetSourcePoint(Bool_t,TVector3=TVector3(0,0,0));
